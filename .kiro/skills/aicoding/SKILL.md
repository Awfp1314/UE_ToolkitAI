...
keywords: coding, guidelines, protocol, refactor, architecture, code-review, best-practices
---
...
- **Orphan Code Handling:** Only remove imports, variables, or functions that became unused _because of your changes_. Do not remove pre-existing dead code unless explicitly instructed.
