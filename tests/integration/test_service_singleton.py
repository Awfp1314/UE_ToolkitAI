...
def test_service_dependency_order(clean_services):
    ...
    from core.services import (
        log_service, path_service,
        config_service, style_service,
        thread_service
    )
...
def test_cleanup_all_services(clean_services):
    ...
    """
    from core.services import (
        log_service, path_service, config_service,
...
def test_service_state_tracking(clean_services):
    ...
    """
    from core.services import log_service, ServiceState
