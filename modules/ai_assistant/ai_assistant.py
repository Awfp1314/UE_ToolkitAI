...
class AIAssistantModule:
    ...
    def get_widget(self) -> QWidget:
        ...
        if self.chat_window is None:
            logger.info("创建 AI 助手占位 UI")
            # 使用占位 UI，避免 NotImplementedError
            from modules.ai_assistant.ui.placeholder_ui import AIAssistantPlaceholderUI
            self.chat_window = AIAssistantPlaceholderUI()
            logger.info("AI 助手占位 UI 创建完成")
            return self.chat_window

            # TODO: 实现完整的聊天窗口 UI
            # 请先创建 modules/ai_assistant/ui/chat_window.py
            # raise NotImplementedError(
            #     "UI 尚未实现，请先创建 modules/ai_assistant/ui/chat_window.py"
            # )
