...
class SiteRecommendationsModule:
    ...
    def get_widget(self) -> QWidget:
        ...
        if self.ui is None:
            logger.info("创建作者推荐占位 UI")
            # 使用占位 UI，避免 NotImplementedError
            from modules.site_recommendations.ui.placeholder_ui import SiteRecommendationsPlaceholderUI
            self.ui = SiteRecommendationsPlaceholderUI()
            logger.info("作者推荐占位 UI 创建完成")
            return self.ui

            # TODO: 实现完整的作者推荐 UI
            # 请先创建 modules/site_recommendations/ui/ 目录和 UI 类
            # raise NotImplementedError(
            #     "UI 尚未实现，请先创建 modules/site_recommendations/ui/ 目录和相应的 UI 类"
            # )
