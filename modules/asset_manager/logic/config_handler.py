...
class ConfigHandler:
    ...
    def save_config(self, assets: List, categories: List[str]) -> bool:
        ...
        try:
            ...
            # 保存配置
            return self._config_manager.save_user_config(config, backup_reason="manual_save")
    ...
    def set_asset_library_path(self, library_path: Path) -> bool:
        ...
        try:
            ...
            return self._config_manager.save_user_config(config, backup_reason="set_library_path")
        except Exception as e:
