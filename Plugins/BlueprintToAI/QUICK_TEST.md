...
1. AI 调用 `extract_active_blueprint` 工具
2. 自动获取当前打开的蓝图路径
3. 返回蓝图的结构信息
4. AI 用自然语言描述蓝图的功能

**✅ 成功**：AI 能够自动识别并分析当前打开的蓝图  
**❌ 失败**：查看错误信息

**常见错误**：

- `No Blueprint is currently open` - 没有打开任何蓝图，请先在 UE 中打开一个蓝图
- `AssetEditorSubsystem not available` - 编辑器子系统不可用，重启 UE
