...
本插件通过条件编译支持 UE 4.26 和 4.27：

- **FTicker API**：使用 `FTicker`（UE4）而非 `FTSTicker`（UE5）
- **Editor API**：使用 `FAssetEditorManager`（UE4）而非 `UAssetEditorSubsystem`（UE5）
- **Python 集成**：使用 UE4 的 Python 插件基础功能
