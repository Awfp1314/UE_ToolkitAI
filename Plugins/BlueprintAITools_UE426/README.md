# BlueprintAITools - UE 4.26 版本

专为 **Unreal Engine 4.26.x** 编译的蓝图分析插件。
...
- **目标引擎**：UE 4.26.x
- **Ticker API**：FTicker
- **Editor API**：FAssetEditorManager
- **Python 支持**：基础功能
...
```bash
# 创建测试项目
# 在 Epic Games Launcher 中创建 UE 4.26 的空白 C++ 项目
...
└── Binaries/                    ← 编译后生成（需要编译）
    └── Win64/
        └── UE4Editor-BlueprintAITools.dll
```
